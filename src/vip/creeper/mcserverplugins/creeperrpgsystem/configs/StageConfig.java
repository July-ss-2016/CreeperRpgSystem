...
public class StageConfig implements RpgConfig {
    ...
    public void loadConfig() {
        Bukkit.getScheduler().runTask(plugin, () -> {
            ...
            File folder = new File(FileUtil.PLUGIN_DATA_FOLDER_PATH + File.separator + "stages");
            ...
            if (folderFiles.length == 0) {
                FileUtil.copySrcFile("stages_0_8.yml", folder.getAbsolutePath() + File.separator + "stages_0_88.yml");
            }
